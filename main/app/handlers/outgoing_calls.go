...
func OutgoingCallsHandler(c *gin.Context) {
	...
	tmpl, err := template.ParseFiles("main/app/static/outgoingCalls.html", "main/app/static/slidebar.html", "main/app/static/header.html")
	if err != nil {
